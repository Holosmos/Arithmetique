...
\item Si la proposition est vérifiée pour $a=k$ alors pour $a=k+1$ c'est également vérifié en raison du résultat précédent : \[ (k+1)^{p}\congru k^{p} + 1 \congru k +1 \mod p.\]
\end{enumerate}
}{}
